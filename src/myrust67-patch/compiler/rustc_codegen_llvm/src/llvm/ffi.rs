...
extern "C" {
    ...
    pub fn LLVMRustCreateTargetMachine(
        ...
        fnoIntegratedAS: bool // xie. modify 对应的修改函数声明
    ) -> Option<&'static mut TargetMachine>;

    // xie. modify 我们在rust_llvm/llvm_wrapper/PassWrapper.cpp中实现了C函数，如果Rust要调用它的话，就需要有一个extern "C" fn fun_name()的声明。
    // xie. modify 我们在这里声明LLVMExecGAS()的Rust函数，供write.rs中通过llvm::LLVMExecGAS()来调用
    pub fn LLVMExecGAS(
        arch: *const c_char,
